...
label_3 =Label(root,text="Discord ID", width=21,font=("bold",10))
label_3.place(x=68,y=180)

entry_3=Entry(root)
entry_3.place(x=240,y=180)

label_7 =Label(root,text="Techstack ", width=20,font=("bold",10))
label_7.place(x=90,y=380)

entry_7=Entry(root)
entry_7.place(x=270,y=380)
...
Checkbutton(root,text="Beginner", variable=var1).place(x=240,y=330)


#the variable 'var2' mentioned here holds Integer Value, by default 0
var2=IntVar()
Checkbutton(root,text="Intermediate", variable=var2).place(x=300,y=330)
...
Button(root, text='Submit' , width=20,bg="black",fg='white').place(x=180,y=430)
